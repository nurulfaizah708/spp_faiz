...
class MasterData extends CI_Controller
{
    ...
    public function list_petugas()
    {
        ...
        foreach ($data as $petugas) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $petugas->ID_PETUGAS . '" class="btn btn-sm 
                btn btn-success" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/petugas_del/') .  $petugas->ID_PETUGAS . '" class="btn btn-sm 
                btn-warning tombol-hapus">Hapus</a>
                </td>';
            echo '</tr>';
            echo "<script>
    ...
    { 
        ...
        if ($cek->num_rows() > 0) {
            // ada data terkait,roolback transaksi dan hentikan proses penghapusan
        ...
        // jika admin sudah menghapus maka masukkan ke dalam log activity
        // var_dump('test'); die;
        ...
        //     $assign_to = '';
        //     $assign_type = '';
        //     activty_log('petugas', 'menghapus data petugas', $assign_to, $assign_type);
    ...
    public function petugas_pass()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->db->affected_rows() > 0) {
                ...
                $this->session->set_flashdata;
                $this->session->set_flashdata('message',  '<div class="alert alert-danger" role"alert">data berhasil diubah</div>');
                redirect('masterdata/petugas');
            } else {
                return false;
            }
    ...
    public function list_siswa()
    {
        ...
        foreach ($data as $siswa) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $siswa->NISN . '" class="btn btn-sm btn btn-success" 
                data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/siswa_del/') .  $siswa->NISN . '" class="btn btn-sm btn-warning tombol-hapus"  
                id="delete" name="delete">Hapus</a>
                </td>';
            echo '</tr>';
            echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
    ...
    public function add_siswa()
    {
        ...
        $this->form_validation->set_rules('NIS', 'NIS', 'required|trim|min_length[8]|max_length[8]|is_unique[tbl_siswa.NIS]', [
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->db->affected_rows() > 0) {
                ...
                $this->session->set_flashdata('message',  'message',  '<div class="alert alert-danger" role"alert">data berhasil ditambahkan</div>');
    ...
    public function list_spp()
    {
        ...
        foreach ($data as $spp) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $spp->ID_SPP . '" class="btn btn-sm btn 
                btn-success" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/spp_del/') .  $spp->ID_SPP . '" class="btn btn-sm btn-warning tombol-hapus" 
                 id="delete" name="delete">Hapus</a>
                </td>';
            echo '</tr>';
             echo "<script>
    ...
    public function list_jurusan()
    {
        ...
        foreach ($data as $jurusan) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $jurusan->ID_JURUSAN . '" class="btn btn-sm btn-success" data-popup="tooltip" data-placement="top" title="Edit Data"><i class="fas fa-edit"></i></a>
