...
<aside class="main-sidebar sidebar bg-light elevation-4">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?= base_url('assets/') ?>img/avatars/kopi.jpg" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
               ...
               with font-awesome or any other icon font library -->
                ...
                <?php if ($title == 'Home') : ?>
                    <li class="nav-item has-treeview">
                        ...
                        <?php else : ?>
                    <li class="nav-item has-treeview">
                        <a href="<?= base_url('user') ?>" class="nav-link text-black">
                        <?php endif ?>
                        ...
                        <?php if ($title == 'Data Petugas' || $title == 'Data Siswa' || $title == 'Data SPP' || $title == 'Data Kelas' || $title == 'Data Jurusan') : ?>
                                ...
                                <ul class="nav nav-treeview">
                                    <?php if ($title == 'Data Petugas') : ?>
                                        <li class="nav-item has-treeview menu-open">
                                            ...
                                            <?php else : ?>
                                        <li class="nav-item">
                                            <a href="<?= site_url('masterdata/petugas') ?>" class="nav-link text-black">
                                        ...
                                        <?php if ($title == 'Data Siswa') : ?>
                                            <li class="nav-item has-treeview menu-open">
                                                ...
                                                <?php else : ?>
                                            <li class="nav-item">
                                                <a href="<?= site_url('masterdata/siswa') ?>" class="nav-link text-black">
                                                    <i class="far nav-icon"></i>
                                                <?php endif; ?>
                                                <p>Data Siswa</p>
                                                </a>
                                            ...
                                            <?php if ($title == 'Data SPP') : ?>
                                                <li class="nav-item has-treeview menu-open">
                                                    ...
                                                    <?php else : ?>
                                                <li class="nav-item">
                                                    <a href="<?= site_url('masterdata/spp') ?>" class="nav-link text-black">
                                                        <i class="far nav-icon"></i>
                                                    <?php endif; ?>
                                                    <p>Data SPP</p>
                                                    </a>
                                                ...
                                                <?php if ($title == 'Data Kelas') : ?>
                                                    <li class="nav-item has-treeview menu-open">
                                                        ...
                                                        <?php else : ?>
                                                    <li class="nav-item">
                                                        <a href="<?= site_url('masterdata/kelas') ?>" class="nav-link text-black">
                                                            <i class="far nav-icon"></i>
                                                        <?php endif ?>
                                                        <p>Data Kelas</p>
                                                        </a>
                                                    ...
                                                    <?php if ($title == 'Data Jurusan') : ?>
                                                        <li class="nav-item has-treeview menu-open">
                                                            ...
                                                            <?php else : ?>
                                                        <li class="nav-item">
                                                            <a href="<?= site_url('masterdata/jurusan') ?>" class="nav-link text-black">
                                                                <i class="far nav-icon"></i>
                                                            <?php endif ?>
                                                            <p>Data Jurusan</p>
                                                            </a>
                            ...
                            <?php if ($title == 'Entri Transaksi Pembayaran') : ?>
                                <li class="nav-item menu-open">
                                    ...
                                    <?php else : ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('pembayaran') ?>" class="nav-link text-black">
                                    <?php endif ?>
                                ...
                                <?php if ($title == 'Lihat History Pembayaran') : ?>
                                    <li class="nav-item menu-open">
                                        ...
                                        <?php else : ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url('pembayaran/history') ?>" class="nav-link text-black">
                                        <?php endif ?>
                                    ...
                                    <?php if ($title == 'Generate Laporan') : ?>
                                        <li class="nav-item menu-open">
                                            ...
                                            <?php else : ?>
                                        <li class="nav-item">
                                            <a href="<?= base_url('user/laporan') ?>" class="nav-link text-black">
                                            <?php endif ?>
                                    ...
                                    <?php elseif ($this->session->userdata('level') == 'Petugas') : ?>
                                        ...
                                        <?php if ($title == 'Entri Transaksi Pembayaran') : ?>
                                            ...
                                            <?php else : ?>
                                                ...
                                                <li class="nav-item">
                                                    <a href="<?= base_url('auth/logout') ?>" class="nav-link text-black logout">
